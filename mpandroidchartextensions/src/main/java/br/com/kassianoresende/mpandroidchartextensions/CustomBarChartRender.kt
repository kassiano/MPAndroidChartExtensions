...
class CustomBarChartRender(val chart: BarDataProvider, animator: ChartAnimator, viewPortHandler: ViewPortHandler) : BarChartRenderer(chart, animator, viewPortHandler) {

    private var mRadius: Float = 0f

    fun setRadius(mRadius: Int) {
        this.mRadius = mRadius.toFloat()
    }
